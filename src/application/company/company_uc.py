...
class CreateCompany:
    ...
    def execute(self, jwt: str, roles: list, company_entity: CompanyNewEntity,
                objects_cloud: list) -> CompanyEntity:
        return self.__company_repository.new_company(jwt, roles, company_entity, objects_cloud)
